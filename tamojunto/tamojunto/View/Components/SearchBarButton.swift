...
class SearchBarButton: UIView {
    ...
    lazy var searchLbl: UILabel = {
        let lbl = UILabel()
        lbl.text = "Clique aqui para buscar..."
    ...
    func setSubviews(){
        ...
        searchStackView.addArrangedSubview(searchLbl)
    }
    ...
    func setConstraints(){
        ...
        //searchTextField
        NSLayoutConstraint.activate([
            searchLbl.leadingAnchor.constraint(equalTo:   searchBarView.leadingAnchor, constant: 42),
            searchLbl.bottomAnchor.constraint(equalTo:   searchStackView.bottomAnchor),
            searchLbl.topAnchor.constraint(equalTo:  searchStackView.topAnchor)
        ])
    }
